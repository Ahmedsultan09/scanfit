...
- GitHub Actions uses Ubuntu, Node 22, Playwright Chromium/Firefox/WebKit and qpdf. The last published baseline run is [available on GitHub](https://github.com/Ahmedsultan09/scanfit/actions/runs/33495376547); the independent-detector revision must pass the same remote workflow before release.
