...
- [x] Public `@scanfit/browser@0.1.0-alpha.1` npm release with provenance attestation and clean registry-consumer import check. Its missing registry README is corrected by `0.1.0-alpha.2`; `0.1.0-alpha.3` adds the customizable React composition API and complete public API examples.
...
- [x] Configure npm Trusted Publishing for `.github/workflows/publish.yml` and verify the OIDC workflow with the `0.1.0-alpha.1` release.
